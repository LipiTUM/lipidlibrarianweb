...
@Component({
    ...
    templateUrl: './reference-query.component.html',
    styleUrls: ['./reference-query.component.sass']
})
export class ReferenceQueryComponent implements OnInit {
