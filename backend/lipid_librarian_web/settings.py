"""
Django settings for lipid_librarian_web project.
...
ROOT_URLCONF = 'lipid_librarian_web.urls'
...
WSGI_APPLICATION = 'lipid_librarian_web.wsgi.application'
